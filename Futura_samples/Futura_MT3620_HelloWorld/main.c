...
int main(void)
{
    ...
    int fd = GPIO_OpenAsOutput(SAMPLE_LED_1, GPIO_OutputMode_PushPull, GPIO_Value_High);
    int fd2 = GPIO_OpenAsOutput(SAMPLE_LED_2, GPIO_OutputMode_PushPull, GPIO_Value_High);
    int fd3 = GPIO_OpenAsOutput(SAMPLE_LED_3, GPIO_OutputMode_PushPull, GPIO_Value_High);
